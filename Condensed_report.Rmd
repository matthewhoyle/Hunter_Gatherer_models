...
write_csv(waning_results_3, file = "/Users/matthewhoyle/Github_R_projects/Hunter_Gatherer_models/waning_results_3.csv")
...
write_csv(waning_results_14, file = "/Users/matthewhoyle/Github_R_projects/Hunter_Gatherer_models/waning_results_14.csv")
...
#combined_waning <- read_csv("combined_waning_results.csv") %>%
  #mutate(patches = case_when(model == "meta" ~ 7,
                             #model == "single" ~ 1)) %>%
...
ggsave(filename = "combined_plot_patches.pdf", plot = combined_plot, device = "pdf", width = 7, height = 5, path = "/Users/matthewhoyle/Github_R_projects/Hunter_Gatherer_models")
```
